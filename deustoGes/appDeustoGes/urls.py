...
urlpatterns = [
    ...
    # URL PARA GESTIÓN
    path('/responsables/<int:id_responsable>/empleados', views.gestion_empleados, name='gestion_empleados'),
    path('/responsables/<int:id_responsable>/clientes', views.gestion_clientes, name='gestion_clientes'),
    path('/responsables/<int:id_responsable>/tareas', views.gestion_tareas, name='gestion_tareas'),
    path('/responsables/<int:id_responsable>/solicitudes', views.gestion_solicitudes, name='gestion_solicitudes'),

    # URL PARA OBTENER DETALLES
    path("/responsables/<int:id_responsable>/empleados/<int:id_empleado>/detalle", views.show_empleado,
         name='empleado_detail'),
    path("/responsables/<int:id_responsable>/proyectos/<int:id_proyecto>", views.show_proyecto, name='proyecto_detail'),
    path("/clientes/<int:id_cliente>/proyectos/<int:id_proyecto>", views.show_proyecto_cliente,
         name='proyecto_detail_cliente'),
    ...
    path('/responsables/<int:id_responsable>/proyectos/<int:id_solicitud>/create', ProyectoCreateView.as_view(),
    ...
    path('/responsables/<int:id_responsable>/deleted/proyecto/<int:id_proyecto>', views.delete_proyecto,
